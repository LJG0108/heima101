...
public class SDEManager {
    ...
    public void createIndex(){
      //esTemplate.createIndex(Goods.class); //创建索引
...
// System.out.println(goods);
       ...
       //分页查询
//        Page<Goods> page = goodsRepository.findAll(PageRequest.of(1, 3));
...
//        System.out.println(goodsList1);
        ...
        //or或者
        List<Goods> goodsList1 = goodsRepository.findByTitleOrPriceBetween("华为",4000.0,5000.0);
        ...
        public <T> AggregatedPage<T> mapResults(SearchResponse searchResponse, Class<T> aClass, Pageable pageable) {
            ...
            for (SearchHit hit : hits) {
                ...
                if (fragments!=null&&fragments.length>0){
                    ...
                    try {
                        org.apache.commons.beanutils.BeanUtils.setProperty(t,"title",title_highLight); //BeanUtils来自commons-beanutils的包
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
